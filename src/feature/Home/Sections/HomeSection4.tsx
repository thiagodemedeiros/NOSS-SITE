    ...
    return (
        <section className="HomeSection4">
            <div className="HomeSection4Content">
                <a href="https://www.youtube.com/@CumbucaDev" className="HomeSection4Content_Youtube">
                    <img src={youtubeLogo} alt="YouTube Logo" />
                    <h4>/@CumbucaDev</h4>
                </a>
                <a href="https://www.youtube.com/@CumbucaDev" className="HomeSection4Content_Button">
                    <button>
                        Inscreva-se
                    </button>
                </a>
